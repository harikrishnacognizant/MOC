...
function startDataLoading() {
	...
	dojo
			.xhrGet({
				...
				url : "http://blooming-spring-5729.herokuapp.com//webcomponent/loadData",
...
function getScale() {
	...
	dojo
			.xhrGet({
				...
				url : "http://blooming-spring-5729.herokuapp.com//webcomponent/getStartUpData",
			...
			function() {
				...
				dojo
						.xhrGet({
							...
							// "http://webcomponentdemo13.alpha.vmforce.com/getHistoricalRecCount",
							// http://mdmoncloud.alpha.vmforce.com/ for vmforce
							url : "http://blooming-spring-5729.herokuapp.com//webcomponent/getHistoricalRecCount",
...
function displayPieChart() {
	...
	dojo
			.xhrGet({
				...
				// url:
				// "http://webcomponentdemo13.alpha.vmforce.com/getHistoricalRecCount",
				url : "http://blooming-spring-5729.herokuapp.com//webcomponent/getPieChartData",
...
function displayClusteredColumns() {
	...
	dojo
			.xhrGet({
				...
				// url:
				// "http://webcomponentdemo13.alpha.vmforce.com/getHistoricalRecCount",
				url : "http://blooming-spring-5729.herokuapp.com//webcomponent/getClusteredColumnsData",
...
function startProcess() {
	...
	dojo
			.xhrGet({
				...
				// url:
				// "http://webcomponentdemo13.alpha.vmforce.com/startProcess",
				url : "http://blooming-spring-5729.herokuapp.com//webcomponent/startProcess",
...
function getProcessUpdate() {
	...
	dojo
			.xhrGet({
				...
				url : "http://blooming-spring-5729.herokuapp.com//webcomponent/getProcessUpdate",
